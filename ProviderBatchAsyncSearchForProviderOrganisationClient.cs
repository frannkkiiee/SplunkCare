...
namespace Nehta.VendorLibrary.HI
{
    ...
    /// connect to Medicare's service to perform provider HPII validation (for provider organisations not published on the provider directory).
    /// </summary>
    public class ProviderBatchAsyncSearchForProviderOrganisationClient
    {
        internal SearchForProviderOrganisationBatchAsyncPortType providerBatchAsyncSearchForProviderOrganisationClient;
        ...
        /// HI service name.
        /// </summary>
        public const string HIServiceOperation = "ProviderBatchAsyncSearchForProviderOrganisation";
        ...
        public submitSearchForProviderOrganisationResponse BatchSubmitProviderOrganisations(BatchSearchForProviderOrganisationCriteriaType[] request)
        {
            var envelope = new submitSearchForProviderOrganisationRequest()
            {
            ...
            submitSearchForProviderOrganisationResponse1 response1 = null;

            try
            {
                response1 = providerBatchAsyncSearchForProviderOrganisationClient.submitSearchForProviderOrganisation(envelope);
            }
            catch (Exception ex)
            {
        ...
        public retrieveSearchForProviderOrganisationResponse BatchRetrieveProviderOrganisations(retrieveSearchForProviderOrganisation request)
        {
            var envelope = new retrieveSearchForProviderOrganisationRequest()
            {
            ...
            retrieveSearchForProviderOrganisationResponse1 response1 = null;

            try
            {
                response1 = providerBatchAsyncSearchForProviderOrganisationClient.retrieveSearchForProviderOrganisation(envelope);
            }
            catch (Exception ex)
            {
                // Catch generic FaultException and call helper to throw a more specific fault
        ...
        private void InitializeClient(string endpointUrl, string endpointConfigurationName, X509Certificate2 signingCert, X509Certificate2 tlsCert, ProductType product, QualifiedId user, QualifiedId hpio)
        {
            ...
            SearchForProviderOrganisationBatchAsyncPortTypeClient client = null;
        ...
        public void Dispose()
        {
            ClientBase<SearchForProviderOrganisationBatchAsyncPortType> lClient;

            if (providerBatchAsyncSearchForProviderOrganisationClient is ClientBase<SearchForProviderOrganisationBatchAsyncPortType>)
            {
